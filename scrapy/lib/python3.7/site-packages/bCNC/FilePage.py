...
class FileGroup(CNCRibbon.ButtonGroup):
	def __init__(self, main, app):
		CNCRibbon.ButtonGroup.__init__(self, main, N_("File"), app)
		self.grid3rows()
...
class OptionsGroup(CNCRibbon.ButtonGroup):
	def __init__(self, main, app):
		CNCRibbon.ButtonGroup.__init__(self, main, N_("Options"), app)
		self.grid3rows()
...
class PendantGroup(CNCRibbon.ButtonGroup):
	def __init__(self, main, app):
		CNCRibbon.ButtonGroup.__init__(self, main, N_("Pendant"), app)
		self.grid3rows()
...
class CloseGroup(CNCRibbon.ButtonGroup):
	def __init__(self, main, app):
		CNCRibbon.ButtonGroup.__init__(self, main, N_("Close"), app)
...
class SerialFrame(CNCRibbon.PageLabelFrame):
	def __init__(self, main, app):
		CNCRibbon.PageLabelFrame.__init__(self, main, "Serial", _("Serial"), app)
