...
class ButtonGroup(Ribbon.LabelGroup, _LinkApp):
	def __init__(self, main, name, app):
		Ribbon.LabelGroup.__init__(self, main, name)
...
class ButtonMenuGroup(Ribbon.MenuGroup, _LinkApp):
	def __init__(self, main, name, app, menulist=None):
		Ribbon.MenuGroup.__init__(self, main, name, menulist)
		_LinkApp.__init__(self, app)
...
class PageLabelFrame(LabelFrame, _LinkApp):
	def __init__(self, main, name, name_alias_lng, app):
		LabelFrame.__init__(self, main, text=name_alias_lng, foreground="DarkBlue")
		_LinkApp.__init__(self, app)
		self.name = name
...
class PageExLabelFrame(tkExtra.ExLabelFrame, _LinkApp):
	def __init__(self, main, name, name_alias_lng, app):
		tkExtra.ExLabelFrame.__init__(self, main, text=name_alias_lng, foreground="DarkBlue")
		_LinkApp.__init__(self, app)
		self.name = name
...
class Page(Ribbon.Page):
	...
	def __init__(self, main, app, **kw):
		self.app = app
		Ribbon.Page.__init__(self, main, **kw)
		self.register()
	...
	def _register(self, groups, frames):
		if groups:
			for g in groups:
				w = g(self.main._ribbonFrame, self.app)
				Page.groups[w.name] = w

		if frames:
			for f in frames:
				w = f(self.main._pageFrame, self.app)
