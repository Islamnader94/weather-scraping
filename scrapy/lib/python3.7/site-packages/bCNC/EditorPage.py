...
class ClipboardGroup(CNCRibbon.ButtonGroup):
	def __init__(self, main, app):
		CNCRibbon.ButtonGroup.__init__(self, main, N_("Clipboard"), app)
		self.grid2rows()
...
class SelectGroup(CNCRibbon.ButtonGroup):
	def __init__(self, main, app):
		CNCRibbon.ButtonGroup.__init__(self, main, N_("Select"), app)
		self.grid3rows()
...
class EditGroup(CNCRibbon.ButtonMenuGroup):
	def __init__(self, main, app):
		CNCRibbon.ButtonMenuGroup.__init__(self, main, N_("Edit"), app,
...
class MoveGroup(CNCRibbon.ButtonMenuGroup):
	def __init__(self, main, app):
		CNCRibbon.ButtonMenuGroup.__init__(self, main, N_("Move"), app)
		self.grid3rows()
...
class OrderGroup(CNCRibbon.ButtonMenuGroup):
	def __init__(self, main, app):
		CNCRibbon.ButtonMenuGroup.__init__(self, main, N_("Order"), app,
...
class TransformGroup(CNCRibbon.ButtonGroup):
	def __init__(self, main, app):
		CNCRibbon.ButtonGroup.__init__(self, main, N_("Transform"), app)
		self.grid3rows()
...
class RouteGroup(CNCRibbon.ButtonGroup):
	def __init__(self, main, app):
		CNCRibbon.ButtonGroup.__init__(self, main, N_("Route"), app)
		self.grid3rows()
...
class InfoGroup(CNCRibbon.ButtonGroup):
	def __init__(self, main, app):
		CNCRibbon.ButtonGroup.__init__(self, main, N_("Info"), app)
		self.grid2rows()
...
class EditorFrame(CNCRibbon.PageFrame):
	def __init__(self, main, app):
		CNCRibbon.PageFrame.__init__(self, main, "Editor", app)
