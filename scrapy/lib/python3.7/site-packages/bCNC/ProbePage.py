...
class ProbeTabGroup(CNCRibbon.ButtonGroup):
	def __init__(self, main, app):
		CNCRibbon.ButtonGroup.__init__(self, main, N_("Probe"), app)
...
class AutolevelGroup(CNCRibbon.ButtonGroup):
	def __init__(self, main, app):
		CNCRibbon.ButtonGroup.__init__(self, main, "Probe:Autolevel", app)
...
class ProbeCommonFrame(CNCRibbon.PageFrame):
	...
	def __init__(self, main, app):
		CNCRibbon.PageFrame.__init__(self, main, "ProbeCommon", app)
...
class ProbeFrame(CNCRibbon.PageFrame):
	def __init__(self, main, app):
		CNCRibbon.PageFrame.__init__(self, main, "Probe:Probe", app)
...
class AutolevelFrame(CNCRibbon.PageFrame):
	def __init__(self, main, app):
		CNCRibbon.PageFrame.__init__(self, main, "Probe:Autolevel", app)
...
class CameraGroup(CNCRibbon.ButtonGroup):
	def __init__(self, main, app):
		CNCRibbon.ButtonGroup.__init__(self, main, "Probe:Camera", app)
		self.label["background"] = Ribbon._BACKGROUND_GROUP2
		self.grid3rows()
...
class CameraFrame(CNCRibbon.PageFrame):
	def __init__(self, main, app):
		CNCRibbon.PageFrame.__init__(self, main, "Probe:Camera", app)
...
class ToolGroup(CNCRibbon.ButtonGroup):
	def __init__(self, main, app):
		CNCRibbon.ButtonGroup.__init__(self, main, "Probe:Tool", app)
		self.label["background"] = Ribbon._BACKGROUND_GROUP2
...
class ToolFrame(CNCRibbon.PageFrame):
	def __init__(self, main, app):
		CNCRibbon.PageFrame.__init__(self, main, "Probe:Tool", app)
...
#	def __init__(self, main, app):
#		CNCRibbon.PageFrame.__init__(self, main, "Help", app)
#
