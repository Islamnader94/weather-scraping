...
class ConnectionGroup(CNCRibbon.ButtonMenuGroup):
	def __init__(self, main, app):
		CNCRibbon.ButtonMenuGroup.__init__(self, main, N_("Connection"), app,
...
class UserGroup(CNCRibbon.ButtonGroup):
	def __init__(self, main, app):
		CNCRibbon.ButtonGroup.__init__(self, main, "User", app)
		self.grid3rows()
...
class RunGroup(CNCRibbon.ButtonGroup):
	def __init__(self, main, app):
		CNCRibbon.ButtonGroup.__init__(self, main, "Run", app)
...
class DROFrame(CNCRibbon.PageFrame):
	...
	def __init__(self, main, app):
		CNCRibbon.PageFrame.__init__(self, main, "DRO", app)
...
class ControlFrame(CNCRibbon.PageExLabelFrame):
	def __init__(self, main, app):
		CNCRibbon.PageExLabelFrame.__init__(self, main, "Control", _("Control"), app)
...
class StateFrame(CNCRibbon.PageExLabelFrame):
	def __init__(self, main, app):
		global wcsvar
		CNCRibbon.PageExLabelFrame.__init__(self, main, "State", _("State"), app)
		self._gUpdate = False
