...
class ReportDialog(Toplevel):
	...
	def __init__(self, main):
		...
		if main is not None: self.transient(main)
...
class UserButton(Ribbon.LabelButton):
	...
	def __init__(self, main, cnc, button, *args, **kwargs):
		if button == 0:
			Button.__init__(self, main, *args, **kwargs)
		else:
			Ribbon.LabelButton.__init__(self, main, *args, **kwargs)
		self.cnc = cnc
		self.button = button
		self.get()
