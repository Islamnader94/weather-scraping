...
class TerminalGroup(CNCRibbon.ButtonGroup):
	def __init__(self, main, app):
		CNCRibbon.ButtonGroup.__init__(self, main, N_("Terminal"), app)
...
class CommandsGroup(CNCRibbon.ButtonMenuGroup):
	def __init__(self, main, app):
		CNCRibbon.ButtonMenuGroup.__init__(self, main, N_("Commands"), app,
...
class TerminalFrame(CNCRibbon.PageFrame):
	def __init__(self, main, app):
		CNCRibbon.PageFrame.__init__(self, main, N_("Terminal"), app)
